...
const Pagination = () => {
  return (
    <div className="flex items-center justify-between mt-5 w-full">
          ...
          <div className="py-2 px-3 border-2 bg-transparent rounded-[10px] flex items-center justify-around w-auto  hover:bg-[#93674f] hover:text-white duration-200 cursor-pointer " onClick={()=>console.log("hello")}><IoMdArrowDropleft size={25}/>
          ...
          <div className="py-2 px-3 border-2 bg-transparent rounded-[10px] flex items-center justify-around w-auto hover:bg-[#93674f] hover:text-white duration-200 cursor-pointer" onClick={()=>{console.log("next")}}>
