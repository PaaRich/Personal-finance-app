...
const signing = () => {
  return (
    <div className="h-dvh p-5 flex items-center bg-[#f2f3f7] relative">
      <div className="hidden lg:block bg-black text-white py-8 rounded-2xl h-full">
        <p className="pl-5 font-bold text-2xl">finance</p>
        <img className="bg-black rounded-2xl w-[60%]" src={signInLogo} alt="logo" />
        <div className="pl-5 mt-5">
          <p className="font-bold text-2xl mb-3">Keep track of your money <br />
