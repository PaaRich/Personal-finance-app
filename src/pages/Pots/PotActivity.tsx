...
const PotActivity = ({ label, btnLabel, children, submitFn, description, closeFn }: { description: string; label: string; btnLabel: string; children: React.ReactNode; submitFn: () => void; closeFn:()=>void}) => {
